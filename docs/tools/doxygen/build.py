...
parser.add_argument('--doxyfile', help='Path to the Doxyfile to use')
...
doxygen_cmd = ['doxygen', args.doxyfile] if args.doxyfile else ['doxygen']
subprocess.run(doxygen_cmd, shell=True, check=True)
