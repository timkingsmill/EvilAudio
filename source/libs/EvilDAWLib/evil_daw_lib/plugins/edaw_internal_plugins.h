...
namespace evil
{
    ...
    private:
        ...
        //==============================================================================
        /**
         * @brief Creates a plugin instance from a JUCE plugin description.
         * @param description Plugin description to instantiate.
         * @param initialSampleRate Initial sample rate.
         * @param initialBufferSize Initial block size.
         * @param callback Completion callback with instance or error message.
         */
